...
def parse_arguments():
    ...
    parser.add_argument('-n', '--max-translations', type=int, default=1, help='Maximum number of translations to generate for a single tree')
    parser.add_argument('-i', '--indices', type=str, help='Path to the indices CSV file')
