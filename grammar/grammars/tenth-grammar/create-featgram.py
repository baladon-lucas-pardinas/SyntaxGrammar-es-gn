...
if __package__ in (None, ""):
    ...
    from lexical_productions.adverbs import write_adverb_productions
...
def main():
    ...
    [verb_lexicon, noun_lexicon, transitivities_file] = [
        config["verbs"],
        config["nouns"],
        config["transitivities"],
    ]
    ...
    with open(output_file, "a") as grammar_file:
        ...
        if "adverbs" in config:
            write_adverb_productions(grammar_file, config["adverbs"])
