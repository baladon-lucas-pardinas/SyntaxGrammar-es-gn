...
def parse_arguments():
    ...
    parser.add_argument(
        "feature_grammar_path", type=str, help="Path to the Feature grammar file"
    )
    parser.add_argument(
        "-n", "--number", type=int, default=100, help="Number of sentences to generate"
    )
    parser.add_argument(
        "-o", "--output", type=str, default="output.txt", help="Path to the output file"
    )
    parser.add_argument(
        "-t",
        "--trees-file",
        type=str,
        default=None,
        help="Path to the file to write the trees to",
    )
    parser.add_argument(
        "-a",
        "--all-sentences",
        action="store_true",
        help="Print all sentences generated by CFG (regardless of validation) to stdout",
    )
    parser.add_argument(
        "--seed",
        type=int,
